...
清除方法[参考](https://blog.csdn.net/zhouziyu2011/article/details/61201613)：1.标记清除【V8】（进出环境进行标记）；2.引用计数
...
2.与http兼容性好，握手阶段采用http协议，能通过htto代理服务器
...
非简单请求(PUT，DELETE)：进行http预检，确定来源。通过后后续同简单请求。
